...
pnpm add @clavenar/agent-sdk@1.6.3 @anthropic-ai/sdk
...
```sh
pnpm add @clavenar/agent-sdk@1.6.3 @anthropic-ai/sdk     # Anthropic
pnpm add @clavenar/agent-sdk@1.6.3 openai                # OpenAI
```
