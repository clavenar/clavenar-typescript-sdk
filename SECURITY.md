...
to a clavenar-lite ingress. It does NOT:

- Run policy evaluation locally (the clavenar-lite process does).
...
The SDK trusts the clavenar-lite ingress at `opts.endpoint`. If that
...
clavenar-lite in your own infra (per the roadmap's hosting model) or
